...
class SignatoryBioPage2 {

  elements = {
    stepHeader() {
      return cy.contains('Signatory Bio (2/2)')
    },
  ...
  verifyPageIsDisplayed() {
    Logger.step('Verifying Signatory Bio (2/2) page is displayed')
    this.elements.stepHeader().should('be.visible')
    Logger.info('Signatory Bio (2/2) page displayed successfully')
  }
  ...
  /**
   * Select a random state from the dropdown.
   */
  selectState() {
  ...
  clickContinue() {
    Logger.step('Clicking Continue button on Signatory Bio (2/2)')
    this.elements.continueButton().should('be.visible').click()
    Logger.info('Continue button clicked successfully')
  }

  completeSignatoryBio2(data) {
    Logger.step('Completing Signatory Bio (2/2) step')
    ...
    this.clickContinue()
    Logger.info('Signatory Bio (2/2) step completed')
  }

}

export default new SignatoryBioPage2();
